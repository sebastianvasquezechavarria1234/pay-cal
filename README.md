...
- 💵 **Basic Salary Calculation**: Multiplies hours by hourly wage to determine the base salary.
- 🔢 **Precise Rounding**: Demonstrates various rounding techniques (e.g., nearest number, rounding up) for accurate financial calculations.
- 🚌 **Subsidy Eligibility**: Automatically checks if the employee earns less than twice the minimum wage to apply the transportation subsidy.
- 📊 **Formatted Output**: Displays the results clearly in a local currency format (`COP`).
